 ...
 * \sa SDL_ShowOpenFolderDialog
 */
typedef void(*SDL_DialogFileCallback)(const char* const*, void*);
 ...
 *
 * If an error occurs, the error can be obtained with SDL_GetError().
 *
 ...
 * \param window The window to bind the dialog to. May be NULL. Not all platforms support this option.
 ...
 * \param default_location The default location to start the dialog at. May be NULL. Not all platforms support this option.
 ...
 * \sa SDL_ShowOpenFolderDialog
 */
extern DECLSPEC void SDLCALL SDL_ShowOpenFileDialog(SDL_DialogFileCallback callback, void* userdata, SDL_Window* window, const SDL_DialogFileFilter *filters, const char* default_location, int allow_many);
 ...
 * \sa SDL_ShowSaveFileDialog
 */
extern DECLSPEC void SDLCALL SDL_ShowOpenFolderDialog(SDL_DialogFileCallback callback, void* userdata, SDL_Window* window, const char* default_location, int allow_many);
